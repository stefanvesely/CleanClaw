...
- [x] Local timeout or complexity threshold triggers frontier-review prompt.
...
- [x] Added a hard headless git policy guard that rejects commits during headless execution.
...
- [x] Headless must never commit; commits remain explicit user actions outside headless execution.
...
- [x] Use numbered menus for major choices:
...
- [x] Local-only task never calls frontier.
...
- [x] Setup checks for NemoClaw/OpenShell.
- [x] Startup checks whether NemoClaw is running.
